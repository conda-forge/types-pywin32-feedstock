...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/types-pywin32-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/types-pywin32-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add types-pywin32
# for installing globally
pixi global install types-pywin32
```
...
It is possible to list all of the versions of `types-pywin32` available on your platform:
...
```
pixi search types-pywin32 --channel conda-forge
```
